...
\section{Fondements théoriques}\label{fondements-thuxe9oriques}

La théorie de l'agence se comprend d'abord comme une réponse à un fait majeur du capitalisme moderne : dans les grandes entreprises, \textbf{ceux qui possèdent ne dirigent pas toujours}. C'est précisément ce que mettent en lumière Berle \& Means dans \textbf{\emph{The Modern Corporation and Private Property (1932) }} : la séparation entre actionnaires et dirigeants ouvre mécaniquement la porte à des \textbf{intérêts divergents} (priorités, effort, prise de risque) et à un problème central de \textbf{surveillance}. Autrement dit, dès que la décision est déléguée, une question s'impose : comment s'assurer que l'agent agira réellement dans l'intérêt du principal, alors même que ce dernier ne peut pas tout observer ?

Pour comprendre pourquoi ce problème devient si important, il faut revenir à la raison d'être de l'entreprise. Dans \textbf{\emph{The Nature of the Firm (1937, Economica)}}, Coase explique que la firme existe parce que le recours au marché est coûteux : négocier, rédiger, contrôler et faire appliquer des contrats en permanence génère des \textbf{coûts de transaction}. Cependant, si l'entreprise réduit certains coûts du marché, elle ne supprime pas les frictions ; elle les \textbf{déplace} vers l'intérieur. En interne, la coordination repose sur la hiérarchie, la mesure de la performance, la supervision---et donc sur une multitude de relations de délégation. Ainsi, plus l'organisation grandit, plus le problème ``principal--agent'' devient structurel.

C'est dans ce cadre que Jensen \& Meckling proposent la formulation devenue canonique avec \textbf{\emph{Theory of the Firm: Managerial Behavior, Agency Costs and Ownership Structure (1976, Journal of Financial Economics)}} : l'entreprise est un \textbf{nœud de contrats}, et les dysfonctionnements ne relèvent pas d'une ``mauvaise volonté'', mais de \textbf{coûts d'agence} (surveillance, engagement, perte résiduelle quand l'alignement reste imparfait). Dès lors, toute la question devient un problème de \textbf{design} : quelles règles de gouvernance, quelle structure de propriété, et surtout quels contrats permettent de rapprocher les intérêts ? La réponse se précise encore avec Holmström dans \textbf{\emph{Moral Hazard and Observability (1979, The Bell Journal of Economics) }} : lorsque l'effort n'est pas observable (ou pas contractible), on ne peut pas obtenir le ``first best'' ; le contrat optimal arbitre alors entre \textbf{assurer} l'agent contre le risque et \textbf{l'inciter} via une rémunération dépendante du résultat. C'est cette tension---fluide, omniprésente et réaliste---qui explique à la fois l'émergence de la théorie de l'agence et son importance dans la compréhension de la firme moderne.
...
On fait une représentation graphique de l'arbre du jeu :
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{images/arbre.jpeg}}
\caption{png}
\end{figure}
...
\chapter*{References / Citations}\label{references-citations}
\addcontentsline{toc}{chapter}{References / Citations}

\begin{itemize}
\tightlist
\item
  Berle, A. \& Means, G. \textbf{\emph{The Modern Corporation and Private Property}} (1932).
\item
  Coase, R. \textbf{\emph{The Nature of the Firm}} (1937, \emph{Economica}).
\item
  Jensen, M. \& Meckling, W. \textbf{\emph{Theory of the Firm: Managerial Behavior, Agency Costs and Ownership Structure}} (1976, \emph{Journal of Financial Economics}).
\item
  Holmström, B. \textbf{\emph{Moral Hazard and Observability}} (1979, \emph{The Bell Journal of Economics}).
\end{itemize}
